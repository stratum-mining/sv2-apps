...
use stratum_core::{
    codec_sv2::{
        Decoded, Decrypted, EncodableFrame, Handshake, HandshakeMessage, NoiseDecoder,
        NoiseEncoder, Transport, TransportDecryptState, TransportEncryptState,
...
use stratum_core::{codec_sv2::SerializedFrame, noise_sv2::ELLSWIFT_ENCODING_SIZE};
...
impl NoiseTcpReadHalf {
    ...
    fn next_frame(&mut self) -> Result<Option<SerializedFrame>, Error> {
        let state = self
            .state
            .take()
